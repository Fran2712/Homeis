...
public class AdaptadorRecyclerChats extends RecyclerView.Adapter<AdaptadorRecyclerChats.ContenedorDeVistas> {
    private ArrayList<Notificacion> lista_notificaciones;
    private boolean estado = true;

    public AdaptadorRecyclerChats(ArrayList<Notificacion> lista_notificaciones) {
