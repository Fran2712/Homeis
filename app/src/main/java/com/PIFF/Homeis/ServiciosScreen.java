...
public class ServiciosScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Servicio c1 = new Servicio("Mandarina","Sierra radial","Por si acaso necesitas una sierra radial poes eso, yo se la dejo");
        Servicio c2 = new Servicio("Vegetta777","Aspiradora sin cablee pro","Hey muy buenas a todos guapisimos, aqui tengo una aspiradora sin cable por si alguien la quiere");
        Servicio c3 = new Servicio("Arnold","Pala","Termine de cavar un hueco en el campo y no voy a usar la pala, si alguien la quiere que me lo diga");
        ...
        adapt = new AdaptadorRecyclerServicios(liata);
