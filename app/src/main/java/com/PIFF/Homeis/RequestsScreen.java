...
public class RequestsScreen extends AppCompatActivity {
    ...
    private RecyclerView.LayoutManager gestor_service;
    private RecyclerView.LayoutManager gestor_tool;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Request r5 = new Request("John Prenup", "IT Assistance", "How do I get all my cat pictures into my phone?", new Date());

        ArrayList<Request> service_requests = new ArrayList<>();
        service_requests.add(r1);
        service_requests.add(r2);
        service_requests.add(r5);
        ...
        Request r6 = new Request("John Prenup", "IT Assistance", "How do I get all my cat pictures into my phone?", new Date());

        ArrayList<Request> tool_requests = new ArrayList<>();
        tool_requests.add(r3);
        tool_requests.add(r4);
        tool_requests.add(r6);

        gestor_service = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        ...
        request_recycler_services.setLayoutManager(gestor_service);

        //SETTING TOOL REQUESTS RECYCLER
        gestor_tool = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        adapt_tool = new AdaptadorRecyclerRequests(tool_requests);
        request_recycler_tools.setAdapter(adapt_tool);
        request_recycler_tools.setLayoutManager(gestor_tool);
